...
class IntroVectors(Scene):
	def construct(self):
		...
		vec3 = Line(start=plane.c2p(-1,1), end=plane.c2p(-1,0), color=RED).add_tip()
...
class VectorAddition(VectorScene):
	def construct(self):
		...
		self.play(Create(resultant_vec, run_time=2))
