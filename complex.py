...
class DivideComplex(Scene):
  def construct(self):
    ...
    self.wait()
    problem2 = Tex(r"$\dfrac{3+2i}{2+i}$").next_to(txt_complex_denom, DOWN)
    ...
    self.wait()
    problem2_step2 = Tex(r"$=\dfrac{(3+2i)(2-i)}{(2+i)(2-i)}$").next_to(problem2_step1, RIGHT)
    self.play(Write(problem2_step2))
    self.wait()
    problem2_step3 = Tex(r"$=\dfrac{3(2)-3(i)+2i(2)-2i(i)}{5}$").next_to(problem2_step2, 1.5*DOWN)
    self.play(Write(problem2_step3))
    self.wait()
    problem2_step4 = Tex(r"$=\dfrac{6-3i+4i-2i^2}{5}$").next_to(problem2_step3, DOWN)
    self.play(Write(problem2_step4))
    self.wait()
    problem2_step5 = Tex(r"$=\dfrac{6-3i+4i+2}{5}$").next_to(problem2_step4, DOWN)
    self.play(Write(problem2_step5))
    self.wait()
    problem2_step6 = Tex(r"$=\dfrac{8+i}{5}$").next_to(problem2_step5, DOWN)
    self.play(Write(problem2_step6))
    self.wait()
    answer2 = Tex(r"$=\dfrac{8}{5} + \dfrac{1}{5}i$").next_to(problem2_step6, RIGHT)
    ...
    problem2_grp = VGroup(problem2, problem2_step1, problem2_step2, problem2_step3,
                    problem2_step4, problem2_step5, problem2_step6, answer2,
                    answer2_box)
